"""
If you get a ModuleNotFoundError for a module 'django.core.urlresolvers'
change the module to 'django.urls' which seems to be the new equivalent
module.

https://stackoverflow.com/questions/43139081/importerror-no-module-named-django-core-urlresolvers

For building URL regex, use this resource:
...
from .views import new_topic  # added by me

"""
When you add something to views.py, it needs to be imported
here. In my case, "here" means "above this multiline comment."

I.e. there is a "board_topics" function in views.py,
and these tests fail without the line:
